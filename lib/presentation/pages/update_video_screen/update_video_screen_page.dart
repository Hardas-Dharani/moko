...
class UpdateVideoScreen extends GetView<UpdateVideoController> {
  UpdateVideoScreen({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(UpdateVideoController());
    return Scaffold(
      ...
      body: GetBuilder<UpdateVideoController>(builder: (_) {
