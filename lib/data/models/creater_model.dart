...
class CreaterData {
  List<SliderByGenres>? creators;

  CreaterData({this.creators});

  CreaterData.fromJson(Map<String, dynamic> json) {
    if (json['creators'] != null) {
      creators = <SliderByGenres>[];
      json['creators'].forEach((v) {
        creators!.add(new SliderByGenres.fromJson(v));
      });
    }
  }
...
class CreaterModel {
  ...
  CreaterModel({this.status, this.message, this.data});

  CreaterModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? new CreaterData.fromJson(json['data']) : null;
  }
